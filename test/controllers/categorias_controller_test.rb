...
class CategoriasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categoria" do
    assert_difference('Categoria.count') do
      post categorias_url, params: { categoria: { descricao: @categoria.descricao, idade_maxima: @categoria.idade_maxima, idade_minima: @categoria.idade_minima, livre: @categoria.livre, tipo_categoria_id: @categoria.tipo_categoria_id } }
    end
  ...
  test "should update categoria" do
    patch categoria_url(@categoria), params: { categoria: { descricao: @categoria.descricao, idade_maxima: @categoria.idade_maxima, idade_minima: @categoria.idade_minima, livre: @categoria.livre, tipo_categoria_id: @categoria.tipo_categoria_id } }
